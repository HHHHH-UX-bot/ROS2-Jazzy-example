...
enum
{
  learning_interface__srv__GetObjectPosition_Event__request__MAX_SIZE = 1
};
// response
enum
{
  learning_interface__srv__GetObjectPosition_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetObjectPosition in the package learning_interface.
typedef struct learning_interface__srv__GetObjectPosition_Event
{
  service_msgs__msg__ServiceEventInfo info;
  learning_interface__srv__GetObjectPosition_Request__Sequence request;
  learning_interface__srv__GetObjectPosition_Response__Sequence response;
} learning_interface__srv__GetObjectPosition_Event;

// Struct for a sequence of learning_interface__srv__GetObjectPosition_Event.
typedef struct learning_interface__srv__GetObjectPosition_Event__Sequence
{
