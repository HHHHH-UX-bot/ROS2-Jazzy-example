...
class Init_GetObjectPosition_Event_response
{
public:
  explicit Init_GetObjectPosition_Event_response(::learning_interface::srv::GetObjectPosition_Event & msg)
  : msg_(msg)
  {}
  ::learning_interface::srv::GetObjectPosition_Event response(::learning_interface::srv::GetObjectPosition_Event::_response_type arg)
  {
...
private:
  ::learning_interface::srv::GetObjectPosition_Event msg_;
};

class Init_GetObjectPosition_Event_request
{
public:
  explicit Init_GetObjectPosition_Event_request(::learning_interface::srv::GetObjectPosition_Event & msg)
  : msg_(msg)
  {}
  Init_GetObjectPosition_Event_response request(::learning_interface::srv::GetObjectPosition_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetObjectPosition_Event_response(msg_);
  }
...
class Init_GetObjectPosition_Event_info
{
public:
  Init_GetObjectPosition_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetObjectPosition_Event_request info(::learning_interface::srv::GetObjectPosition_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetObjectPosition_Event_request(msg_);
  }
...
template<>
inline
auto build<::learning_interface::srv::GetObjectPosition_Event>()
{
  return learning_interface::srv::builder::Init_GetObjectPosition_Event_info();
}
