...
enum
{
  learning_interface__action__MoveCircle_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  learning_interface__action__MoveCircle_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/MoveCircle in the package learning_interface.
typedef struct learning_interface__action__MoveCircle_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  learning_interface__action__MoveCircle_SendGoal_Request__Sequence request;
  learning_interface__action__MoveCircle_SendGoal_Response__Sequence response;
} learning_interface__action__MoveCircle_SendGoal_Event;

// Struct for a sequence of learning_interface__action__MoveCircle_SendGoal_Event.
typedef struct learning_interface__action__MoveCircle_SendGoal_Event__Sequence
{
...
enum
{
  learning_interface__action__MoveCircle_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  learning_interface__action__MoveCircle_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/MoveCircle in the package learning_interface.
typedef struct learning_interface__action__MoveCircle_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  learning_interface__action__MoveCircle_GetResult_Request__Sequence request;
  learning_interface__action__MoveCircle_GetResult_Response__Sequence response;
} learning_interface__action__MoveCircle_GetResult_Event;

// Struct for a sequence of learning_interface__action__MoveCircle_GetResult_Event.
typedef struct learning_interface__action__MoveCircle_GetResult_Event__Sequence
{
