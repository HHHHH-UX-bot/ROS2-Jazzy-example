...
class Metaclass_GetObjectPosition_Event(type):
    """Metaclass of message 'GetObjectPosition_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_object_position__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_object_position__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_object_position__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_object_position__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_object_position__event
...
class GetObjectPosition_Event(metaclass=Metaclass_GetObjectPosition_Event):
    """Message class 'GetObjectPosition_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<learning_interface/GetObjectPosition_Request, 1>',
        'response': 'sequence<learning_interface/GetObjectPosition_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['learning_interface', 'srv'], 'GetObjectPosition_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['learning_interface', 'srv'], 'GetObjectPosition_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from learning_interface.srv import GetObjectPosition_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetObjectPosition_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetObjectPosition_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from learning_interface.srv import GetObjectPosition_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetObjectPosition_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetObjectPosition_Response'"
...
class Metaclass_GetObjectPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_object_position.Metaclass_GetObjectPosition_Event._TYPE_SUPPORT is None:
                _get_object_position.Metaclass_GetObjectPosition_Event.__import_type_support__()
...
class GetObjectPosition(metaclass=Metaclass_GetObjectPosition):
    ...
    from learning_interface.srv._get_object_position import GetObjectPosition_Event as Event
