...
static const _GetObjectPosition_Event_type_support_symbol_names_t _GetObjectPosition_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, learning_interface, srv, GetObjectPosition_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, learning_interface, srv, GetObjectPosition_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, learning_interface, srv, GetObjectPosition_Event)() {
  return &::learning_interface::srv::rosidl_typesupport_c::GetObjectPosition_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetObjectPosition_service_type_support_handle = {
  ...
  &GetObjectPosition_Request_message_type_support_handle,
  &GetObjectPosition_Response_message_type_support_handle,
  &GetObjectPosition_Event_message_type_support_handle,
