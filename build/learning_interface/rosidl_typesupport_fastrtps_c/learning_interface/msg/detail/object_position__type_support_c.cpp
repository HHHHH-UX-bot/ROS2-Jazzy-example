...
bool cdr_serialize_learning_interface__msg__ObjectPosition(
  const learning_interface__msg__ObjectPosition * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learning_interface
bool cdr_deserialize_learning_interface__msg__ObjectPosition(
  eprosima::fastcdr::Cdr & cdr,
  learning_interface__msg__ObjectPosition * ros_message)
{
  // Field name: x
  {
    cdr >> ros_message->x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = learning_interface__msg__ObjectPosition;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learning_interface
bool cdr_serialize_key_learning_interface__msg__ObjectPosition(
  const learning_interface__msg__ObjectPosition * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: x
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learning_interface
size_t get_serialized_size_key_learning_interface__msg__ObjectPosition(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectPosition__ros_msg_type * ros_message = static_cast<const _ObjectPosition__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_learning_interface
size_t max_serialized_size_key_learning_interface__msg__ObjectPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const learning_interface__msg__ObjectPosition * ros_message = static_cast<const learning_interface__msg__ObjectPosition *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_learning_interface__msg__ObjectPosition(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  learning_interface__msg__ObjectPosition * ros_message = static_cast<learning_interface__msg__ObjectPosition *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_learning_interface__msg__ObjectPosition(cdr, ros_message);
}
